...
public class TopicOperatorTestUtil {
    ...
    public static void cleanupNamespace(KubernetesClient kubernetesClient, String name) {
        ...
        try {
            ...
            for (var kafkaTopic : kafkaTopics.getItems()) {
                ...
                modifyTopic(kubernetesClient, kafkaTopic, theKt -> {
    ...
    public static KafkaTopic modifyTopic(KubernetesClient kubernetesClient, KafkaTopic kafkaTopic, UnaryOperator<KafkaTopic> changer) {
